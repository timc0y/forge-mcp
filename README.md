...
Deployed as a private pilot at `https://forge-edge-gateway.timcoy72.workers.dev`
(D1, R2, Durable Objects, Workflows, Browser Run, GitHub OAuth, remote MCP).
`pnpm run deploy` applies pending D1 migrations, then deploys the worker.
