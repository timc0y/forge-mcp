...
- Decision: **not adopted.** Trialled as an in-chat MCP Apps widget, then removed — inconsistent rendering across hosts, and heavy chrome around information already present in the model's reply
