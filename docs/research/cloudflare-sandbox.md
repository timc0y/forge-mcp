...
- Maturity: beta
- Used surface: `getSandbox`, explicit sessions, command/file/process APIs, port exposure, proxying, backups and destroy
...
- Limitations: local Docker is not production parity; preview and backup behavior depend on Cloudflare deployment
