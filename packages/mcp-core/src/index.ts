...
export const forgeTools = [
  ...
  { name: 'forge_git_branch', title: 'Create branch', description: 'Create and check out a local forge/ branch.', inputSchema: { workspace_id: workspaceIdOptional, branch: z.string().startsWith('forge/').max(107), expected_revision: revision, idempotency_key: idempotencyOptional }, sideEffect: 'workspace', approval: 'none' },
