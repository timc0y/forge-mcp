...
const TOOL_INVOCATION_STATUS: Partial<Record<string, ToolInvocationStatus>> = {
  ...
  forge_files_upload: { invoking: 'Uploading file…', invoked: 'File uploaded' },
  ...
  forge_git_rebase: { invoking: 'Rebasing branch…', invoked: 'Rebase complete' },
  ...
  forge_pull_request_create: { invoking: 'Creating PR…', invoked: 'PR created' },
  ...
  forge_files_replace: { invoking: 'Replacing in file…', invoked: 'File updated' },
